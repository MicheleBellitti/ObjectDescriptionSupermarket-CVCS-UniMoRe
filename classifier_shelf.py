...
# # You can print the final array if needed
...
#     print("y1:", item[3])
#     print("y2:", item[4])
#     print("x_center:", item[5])
#     print("y_center:", item[6])
#     print("shelfnumber:", item[7])
...
# Assuming that the `final_array` is already created and contains the required information
