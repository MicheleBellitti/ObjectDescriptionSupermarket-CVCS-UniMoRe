...
image_path = f"/work/cvcs_2023_group23/SKU110K_fixed/images/test_{random.randint(0,NUM_TEST_IMAGES)}.jpg"  # Update this path
...
def main(image_path):
    ...
    pca_embeddings = np.array(embeddings)   
